...
def main():
    if brightness is True:
        ...
        npaContours, npaHierarchy = cv2.findContours(croppedmask,
        ...
        for contourWithData in validContoursWithData:  # for each contour
            ...
            cv2.rectangle(rectangle,  # draw rectangle on original testing image
                          ...
                          1)  # thickness
            space = 4
            imgROI = croppedmask[ contourWithData.intRectY - space : contourWithData.intRectY + contourWithData.intRectHeight + space ,
            ...
            eroded = cv2.erode(imgROIResized, kernel, iterations=1)

            npaROIResized = eroded.reshape(
        ...
        toshow = cv2.resize(croppedmask, (200, 200))
        cv2.imshow("what", toshow)
